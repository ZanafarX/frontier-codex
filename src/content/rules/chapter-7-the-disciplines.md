---
title: "Chapter 7: The Disciplines"
book: "current"
chapter: 7
order: 8
summary: "Orientation to the five Psionic Disciplines — their roles, signature mechanics, and how to choose."
tags: ["psionic", "disciplines", "world"]
---
...
| Discipline | Focus | Key Stat | Role |
| :-- | :-- | :-: | :-- |
| **Psy-Slinger** | Firearm | QUICK | Damage |
| **Mindweaver** | Prism/Mirror | SWAY | Control |
| **Seer** | Cards/Dice | SAVVY | Support |
| **Flesh Shaper** | Surgical Tools | GRIT | Healer |
| **Bastion Soul** | Iron/Stone | IRON | Tank |
...
## Mindweaver: The Whispering Gallery
...
Mechanically, Seers are **support specialists** who manipulate probability and information. They reroll dice, grant Advantage to allies, retroactively declare preparation, and execute targets with delayed strikes the target *knows* are coming. The Seer's signature rules are the **Seer Reaction Convention** (their first Reaction per scene is cheaper) and **Miracle Reactions Mettle-Free** (their Rank 5 Miracles bypass the Mettle cost normally required of Reactions — the cosmic price is paid in Memory, not adrenaline).
...
Mechanically, Bastion Souls are **tank / anti-psionic specialists**. They block, ward, intercept, and anchor. Their signature universal rules are the **Tier-Removal Hierarchy** (which lower-rank Talent removes which higher-rank effect, with explicit chains) and the **Bastion Soul Reaction Convention** (their Reactions follow specific cost/timing rules distinct from the Seer's). They are the canonical counter to Psionic effects: their toolkit can end active Talents, suppress all channeling within an area, ward objects and allies against the Current, and — at the highest Rank — make a single body utterly immovable.
...
2. **What's your Focus going to be?** A signature gun, a mirror, a deck of cards, a set of bone saws, an iron token. Focus is a roleplay anchor as well as a mechanical one — choose something you'll enjoy describing over and over.

3. **What kind of horror do you want to live with?** Each discipline has a flavor of Veil Bleed: Psy-Slingers go cold and dead-eyed, Mindweavers lose themselves in their own reflections, Seers hear the future as a constant whisper, Flesh Shapers forget where their body ends and others' begin, Bastion Souls turn to stone in the places that should still feel.

4. **What's your Mettle Pool going to look like?** Mettle = (SAVVY + GRIT) ÷ 2, so it's the SAVVY-leaning Seers and the GRIT-leaning Flesh Shapers who draw Mettle from their prime stat. QUICK-focused Psy-Slingers and IRON-focused Bastion Souls get none of it from their prime Attribute — so if your kit leans on Reactions (and the Bastion Soul's are Reaction-heavy), plan to invest in SAVVY or GRIT to fuel them.

5. **How comfortable are you with the cost?** Psy-Slingers and Seers tend to survive longest, because their core kits are Strain-heavy and Erosion-light. Mindweavers and Flesh Shapers burn out faster, because their high-Rank Talents are devastating and frequent. Bastion Souls fall in between, but suffer most from prolonged exposure.
