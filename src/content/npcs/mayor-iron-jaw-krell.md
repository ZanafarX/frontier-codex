---
name: "Mayor \"Iron-Jaw\" Krell"
role: "Mayor of Greystone (retired Ironbrand)"
faction: "ironbrands"
location: "Greystone (High-Rock)"
is_combatant: true
stats:
  tier: "elite"
  hp: 11
...
contracted shifts; the filter system at the cliff base is the kind
of pre-planned exit strategy the guild trains in.

He is not currently under Ironbrand contract, but he is still
branded, and that brand never expires.

## Tactics

Krell commands the High-Rock defense personally during incursions.
His Elite Pool of 7 reflects continued combat training rather than
the diminished readiness common in "retired" mercenaries. His
preference is the same as the guild's: fire-and-maneuver, pre-planned
retreat routes, overlapping fields of fire. The town has practiced
the drills.
