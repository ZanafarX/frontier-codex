---
name: "Elder Rhun, Voice of the Veil"
role: "Leader of the Circle of Ash"
faction: "circle-of-ash"
location: "Palomera (preservation tank beneath the Dovecote)"
is_combatant: true
stats:
  tier: "boss"
  hp: 10
...
fluid that slows his body's decay while his mind ranges across the
Silver Thread of possible futures.

Rhun no longer speaks aloud. His vocal cords atrophied decades ago.
He communicates telepathically, his thoughts arriving in your mind
like memories you didn't make: fully formed, slightly melancholy,
and carrying the faint taste of honey and ash.
...
| :----- | :--: | :-: | :---: | :---- |
| Telekinetic Crush | 10 | 5 | 6 | Range: Far; ignores cover; ignores AR |

## Psionics (ECHO 5, Channel 5)

- All Seer Talents at **Rank 4 and below.**
- **The Rewind (R5 Miracle):** Reset the scene by 10 seconds. Only Rhun remembers what happened. All other participants experience déjà vu but cannot explain it. Cost: 1 Memory (burned).
...
- **Future Echo (1/scene):** Rhun declares that a PC's action fails before they roll. The action automatically fails with a Margin of −1 (Near Miss). The PC experiences the failure as an overwhelming sense of wrongness. Rhun uses this only to prevent outcomes that would damage the Circle.
- **Thread Cascade (1/scene):** Rhun grants all allies within Near range **+3 dice** to their next roll. He does this by showing them, for a fraction of a second, the version of reality where they succeed. Costs him 2 Strain and a nosebleed.

## Tactics

Rhun never fights. Fighting is for people with futures. He is
protected by Guardians, Archivists, and the architectural defenses of
...
Irrelevant. Rhun is beyond fear. He is waiting for his appointment.
