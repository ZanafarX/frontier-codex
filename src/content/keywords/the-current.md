...
aliases:
  ...
  - "the Hum"
  - "the Flow"
short_definition: "The raw chaotic energy of the dimension beyond the Veil. Existed before the Rupture but now leaks freely into our world, pooling in Thin Places and offering power at the cost of soul-erosion. Responsive to thought, indifferent to morality."
category: "narrative"
tags: ["cosmology", "psionic", "veil", "core-lore"]
---
...
- **Salt** disrupts the Current. **Iron** grounds it. These are the
  Frontier's universal countermeasures.

The Circle of Ash studies the Current and seeks to understand it. The
Redeemers consider it inherently corrupting and would purge every
trace. The Consortium views it as a resource to be regulated and
exploited (their Psi-Division). The Dust Vultures drink it through
twisted fauna's blood to build immunity. Each faction's relationship
to the Current defines their relationship to everything else.

(See the **Veil** for the barrier, and **Rupture** for how the barrier
broke.)
