...
aliases:
  ...
  - "The Open State"
  - "Channeling Window"
short_definition: "The phase between when a Psionic declares Channeling and when the Talent resolves. The caster's attention is inward, holding the Current open. They can only Shift, cannot make Reactions, and are vulnerable to Disruption."
category: "state"
tags: ["psionic", "channeling", "vulnerability", "core-mechanic"]
---
...
**Mechanical restrictions while Open:**

- Cannot take other Actions (attention is inward).
- Can Shift (move up to Speed) but cannot Scramble, Rush, Sprint, or
  Take Cover.
- Cannot make Reactions (no Parry, no Intercept, no Dodge, no Dive).
...
| For Psionics | Against Psionics |
| :---- | :---- |
| Channel from cover when possible | Focus fire on Open targets |
| Wait for enemies to engage allies | Save Salt Rounds for the Open moment |
...
(See also the **Open State** condition for the mechanical effect side
of the same state, and the **Disrupted** condition for what happens
