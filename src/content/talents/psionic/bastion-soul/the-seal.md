...
cost:
  memory: 1
tn: 16
tempo: "9 (ritual, 1 hour)"
flavor: "I close the door between worlds. What I lock stays locked."
...
- The breach closes. Reality reasserts itself with a physical shockwave
  (all creatures within Near range are **Knocked Prone**).
- Veil-Born creatures within Near range of the breach are expelled back
  through the Veil. **They cannot return through this point, ever.**
- The Tension Pool is **emptied entirely**.
- For 1 month, the sealed area radiates stability: no Thin Places can
  form within Far range, environmental Erosion does not apply, and the
  Hum is silenced.
