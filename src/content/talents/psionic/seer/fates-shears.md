...
tn: 15
tempo: 6
flavor: "You cut the thread. Their luck dies screaming."
tags: ["debuff", "anti-fate", "anti-mettle", "anti-psionic"]
has_steps: true
has_resist: true
---
...
Sever a target's connection to fortune. For the rest of the scene:
...
The target loses 1 Mettle per Step (the connection to grit and instinct
frays).
