...
tn: 16
tempo: 5
flavor: "I transcend the human form. What I become, I cannot describe."
tags: ["miracle", "transformation", "self-buff", "combat"]
has_steps: false
has_resist: false
---
...
You undergo a total biological transformation that transcends human
capability. For the rest of the scene, you are no longer human:
...
- Your senses extend to **Extreme range** (tremorsense, thermal vision,
  echolocation)
- Your unarmed attacks deal **WR 6** with **Knockdown and Bleed**
- You can Channel **Rank 1–3 Flesh Shaper Talents at no Strain cost**

## Requirement

**The Crash:** When the scene ends, your body reverts catastrophically.
Take **3d6 Strain** (excess converts to Erosion, then to HP damage). You
are **Downed automatically**. An ally must stabilize you with
**Medicine (TN 13)** or you begin Bleeding Out.
