---
name: "Open State"
short_effect: "While channeling a Psionic Talent: cannot take other Actions, cannot make Reactions, can only Shift (no Scramble/Rush/Sprint/Take Cover). Vulnerable to Disruption."
duration: "From the Tick you declare Channeling until the Tick the Talent resolves (Tempo 4-9 for most Talents)"
inflicted_by:
  - "Declaring a Channeling action (any Psionic Talent)"
cleared_by:
  - "Talent resolves at its Tempo (automatic)"
  - "Channeling fails (Disrupted, Fumbled, or voluntarily aborted)"
severity: "moderate"
---
...
**Disrupted** condition for what happens when the vulnerability is
exploited.)
