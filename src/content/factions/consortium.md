---
name: "The Orvain Consortium"
short_name: "consortium"
motto: "Progress at any price. Order through debt."
type: "corporate"
territory:
  - "ash-belt"
primary_methods:
  - "Rail control via the Screaming Rails (rune-etched, lead-reinforced armored trains)"
  - "Protection Contracts that convert towns into indentured-servitude populations"
  - "Industrial extraction of ghost-rock and Ley-Engine Current-tapping"
  - "Psi-Division: controlled exploitation of registered Psionics"
  - "Debt as the primary instrument of governance"
notable_members:
  - "The Board of Directors (faceless Eastern council)"
  - "Rail Barons (frontier governors of station-towns)"
  - "Baron Elias Thorne (Orvain — possibly gone Hollow)"
  - "Director Kael (Head of Psi-Division; Mindweaver)"
---

The Consortium owns the rails, and therefore, they own the future. A
massive industrial combine of bankers, engineers, and ruthless robber
barons, the Consortium controls the flow of food, water, and weapons
...
Contracts**, effectively selling their population into indentured
servitude.
...
Ironbrands. Consortium forces fight defensively, hold positions, use
cover, and call for reinforcements. They prefer to let the enemy come
to them because they can always afford to wait.
