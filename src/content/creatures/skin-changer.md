...
attacks:
  - name: "Claws (true form)"
    ...
    tempo: 4
    qualities: ["bleed"]
    notes: "Bleed (1 HP/turn until treated)."
  - name: "Borrowed Weapon"
    pool: 6
    weapon_rating: 0
    tempo: 0
    qualities: []
    notes: "Uses victim's equipment and fighting style. WR/Tempo vary by weapon stolen."
traits:
...
Skin-Changers. Children stare. The air around them smells faintly of
copper.
