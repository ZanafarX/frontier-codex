...
attacks:
  - name: "Phase-Mandibles"
    ...
    tempo: 4
    qualities: []
    notes: "Ignores mundane AR (passes through non-magical material)."
  - name: "Current Drain"
    pool: 6
    weapon_rating: 0
    tempo: 5
...
within minutes of a high-Rank Channeling event.
...
drawn to whoever has the highest Erosion or whoever used Bleed Dice
most recently.
...
has a price, and the price is never just what you expect.**
