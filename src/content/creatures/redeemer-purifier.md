...
attacks:
  - name: "Coach Gun (Salt Rounds)"
    ...
    tempo: 4
    qualities: ["scatter"]
    notes: "Auto-Disrupts Psionics; +1 Roll Bonus vs. supernatural."
  - name: "Hand Flamer"
    pool: 5
    weapon_rating: 3
    tempo: 5
    qualities: []
    notes: "Fire; Cone (Close range, 3m wide); ignites flammables."
traits:
  - "**Zeal:** Immune to Fear."
...
Fanatical (−4) against supernatural targets. Disciplined (+2) against
mundane threats.
